...
namespace App\Filament\Resources\IndividualAffiliates\Schemas;
...
class IndividualAffiliateInfolist
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ...
            ->components([
                ...
                Tabs::make('individualAffiliateTabs')
                    ->contained()
                    ->persistTabInQueryString('afiliado-tab')
                    ->columnSpanFull()
                        ...
                        Tab::make('General')
                            ...
                            ->schema([
                                Section::make('Datos personales')
                                    ->description('Información de identificación del afiliado individual.')
                                    ->icon(Heroicon::OutlinedIdentification)
                                    ->schema([
                                        Grid::make(2)
                                            ->schema([
                        ...
                        Tab::make('Contacto')
                            ...
                            ->schema([
                                Section::make('Medios de contacto')
                                    ->description('Información de contacto del afiliado.')
