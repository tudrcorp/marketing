...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción al español de los mensajes de error por defecto del validador.
    | Algunas reglas tienen varias versiones (por ejemplo las de tamaño) según
    | el tipo de dato que se valida.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí se pueden definir mensajes propios por atributo con la convención
    | "atributo.regla".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Permiten sustituir el nombre técnico del campo por uno legible.
    |
    */
